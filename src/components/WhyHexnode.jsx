    ...
    cards: [
      {
        ...
        hover_text: "Try Hexnode on your endpoints",
        hover_link:
          "https://www.hexnode.com/mobile-device-management/cloud/signup/",
          style: 'xl:h-[280px] xl:hover:h-[318px] h-fit'
      },
      {
        icon: `<svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        hover_link:
          "https://www.hexnode.com/mobile-device-management/cloud/signup/",
          style: 'xl:h-[252px] xl:hover:h-[290px] h-fit'
      },
      {
        icon: `<svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        hover_text: "Try Hexnode on your endpoints",
        hover_link:"https://www.hexnode.com/mobile-device-management/cloud/signup/",
        style: 'xl:h-[248px] xl:hover:h-[286px] h-fit'
      },
      {
        icon: `<svg
                        xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <>
      <section className="py-[60px] lg:py-[80px] bg-[#F7F7F7] relative">
        <div
          className="absolute top-[-65px] xl:top-[-74px] opacity-0 size-0 m-0"
          id="why-hexnode"
        />
        <div className="main_width">
          <h2 className="antialiased text-[32px] md:text-[40px] leading-[40px] md:leading-[1.2] text-center font-bold text-[#020a19] pb-[10px] max-w-[800px] mx-auto">
            {contents.title}
          </h2>
          <div className="flex flex-wrap justify-center items-start tab:justify-between lg:justify-between xl:justify-between relative">
            {contents.cards.map((data) => (
            ...
            {/* center logo */}
            <div className="whyHexnode hidden xl:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
              <div className="relative z-[10] max-w-[85px] xl:max-w-[105px]">
                <img
                  ...
                  src="/icons/hexnode-app-icon.svg"
                />
              </div>
          ...
          <a
            rel="noreferrer"
            className="text-[18px] leading-[28px] text-[#DD0735] font-semibold text-center block tab:hidden lg:hidden xl:hidden mt-[20px]"
...
const Cards = ({ data }) => {
  return (
    <div
      className="max-w-[340px] tab:max-w-[48%] lg:max-w-[48%] xl:max-w-[480px] flex items-center basis-full tab:basis-[47%] lg:basis-[47%]  xl:basis-1/2 flex-shrink-0 my-[10px] tab:my-[20px] lg:my-[20px] xl:my-0 xl:h-[320px] transition-all delay-300 duration-300 ease-in-out"
    >
      <div
        className={`relative ${data.style} z-[10] p-[20px] lg:p-[40px_40px_20px_40px] xl:p-[40px_40px_20px_40px] rounded-[16px] border border-[#D7D7D7] bg-[#FFFFFF] my-[10px] first:mt-0 last:mb-0 group transition-all delay-300 duration-300 ease-in-out`}
      >
        <div>
          <div className="flex items-center space-x-[10px]">
            <div className="flex justify-center w-full max-w-[28px] lg:max-w-[40px] xl:max-w-[40px] h-full">
              <div dangerouslySetInnerHTML={{ __html: data.icon }} />
            </div>
            <h4 className="antialiased text-[20px] lg:text-[24px] xl:text-[24px] leading-[32px] text-left font-bold text-[#020a19] ">
              {data.title}
            </h4>
          </div>
          <p className="text-[16px] lg:text-[18px] xl:text-[18px] leading-[28px] text-left font-regular text-[#333333] mt-[15px] mb-[15px] lg:mb-[20px] xl:mb-[20px]">
            {data.description}
          </p>
        </div>
        ...
        <a
          rel="noreferrer"
          className="text-[16px] lg:text-[18px] xl:text-[18px] leading-[28px] text-[#DD0735] font-semibold hidden tab:inline-block lg:inline-block lg:pb-[10px] delay-300 transition-all duration-[0.3s] ease-out xl:absolute xl:opacity-0 xl:invisible xl:group-hover:opacity-[1] xl:group-hover:visible"
          href={data.hover_link}
        >
          {data.hover_text}
        </a>
