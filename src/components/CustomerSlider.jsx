...
const CustomerSlider = ({ customers }) => {
  ...
  return (
    <>
      <div className="max-w-[280px] md:max-w-[400px] tab:max-w-[960px] lg:max-w-[780px]  xl:max-w-[960px] pt-[40px] pb-[80px] md:pb-[50px] relative mx-auto lg:pb-0 xl:pb-0">
        <button
        ...
        >
          <img
            alt="previous"
            className={`mx-auto ${currentSlide === 0 ? 'opacity-25' : 'opacity-75 group-hover:opacity-100'}`}
            ...
            <div key={res.name}>
              <div className="flex flex-col tab:flex-row lg:flex-row xl:flex-row overflow-hidden rounded-[18px] relative group ">
                ...
                <div className="max-w-[640px] xl:max-w-full bg-[#f7f7f7] flex justify-between flex-col grow">
                  ...
                  <div className="tab:min-h-[135px] tab:max-h-[135px] md:overflow-scroll p-[20px_20px_30px_20px] tab:px-[20px] lg:px-[40px] xl:px-[40px] lg:py-0 xl:py-0 tab:py-0 tab:mt-[40px] lg:mt-[40px] xl:mt-[40px] scroll_hide">
                  ...
                  <div className="px-[20px] py-[12px] lg:px-[40px] xl:px-[40px] md:py-0 border-t-[1px] border-white/30 flex flex-col justify-center items-center min-h-[73px] md:min-h-[120px] tab:min-h-[120px] lg:min-h-[120px] xl:min-h-[120px] bg-[#020a19]/5">
        ...
        >
          <img
            alt="next "
            className={`mx-auto ${currentSlide === customers.length - 1 ? 'opacity-25' : 'opacity-75 group-hover:opacity-100'}`}
